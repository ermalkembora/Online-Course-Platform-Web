...
<style>
    ...
    h2, .card-title, label, .form-check-label {
        color: #ffffff;
    }
        ...
        <div class="col-md-10">
            <div class="card transparent-card">
                <div class="card-body p-5">
                    ...
                    <form method="POST" id="editLessonForm" class="needs-validation" novalidate>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      id="description" 
                                      name="description" 
                                      rows="2"><?php echo htmlspecialchars($lesson['description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php echo isset($errors['content']) ? 'is-invalid' : ''; ?>" 
                                      id="content" 
                                      name="content" 
                                      rows="10"><?php echo htmlspecialchars($lesson['content'] ?? ''); ?></textarea>
                            <?php if (isset($errors['content'])): ?>
                                <div class="invalid-feedback">
                                    <?php echo htmlspecialchars($errors['content']); ?>
                                </div>
                            <?php endif; ?>
                            <div class="form-text">Either content or video URL is required.</div>
                        </div>
